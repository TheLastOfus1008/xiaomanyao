...
");
if(pdo_tableexists('tyzm_diamondvote_blacklist')) {
...
if(pdo_tableexists('tyzm_diamondvote_blacklist')) {
	if(!pdo_fieldexists('tyzm_diamondvote_blacklist',  'value')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_blacklist')." ADD `value` varchar(50) COMMENT '值';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_blacklist')) {
	if(!pdo_fieldexists('tyzm_diamondvote_blacklist',  'content')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_blacklist')." ADD `content` varchar(50) COMMENT '昵称，IP地区';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_blacklist')) {
...
if(pdo_tableexists('tyzm_diamondvote_count')) {
...
if(pdo_tableexists('tyzm_diamondvote_domainlist')) {
...
if(pdo_tableexists('tyzm_diamondvote_domainlist')) {
	if(!pdo_fieldexists('tyzm_diamondvote_domainlist',  'domain')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_domainlist')." ADD `domain` varchar(50) COMMENT '域名';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_domainlist')) {
...
if(pdo_tableexists('tyzm_diamondvote_fansdata')) {
...
if(pdo_tableexists('tyzm_diamondvote_gift')) {
...
if(pdo_tableexists('tyzm_diamondvote_gift')) {
	if(!pdo_fieldexists('tyzm_diamondvote_gift',  'avatar')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_gift')." ADD `avatar` varchar(255) NOT NULL COMMENT '微信头像';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_gift')) {
	if(!pdo_fieldexists('tyzm_diamondvote_gift',  'nickname')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_gift')." ADD `nickname` varchar(50) NOT NULL COMMENT '微信昵称';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_gift')) {
...
if(pdo_tableexists('tyzm_diamondvote_redpack')) {
...
if(pdo_tableexists('tyzm_diamondvote_redpack')) {
	if(!pdo_fieldexists('tyzm_diamondvote_redpack',  'avatar')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_redpack')." ADD `avatar` varchar(255) NOT NULL COMMENT '头像';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_redpack')) {
	if(!pdo_fieldexists('tyzm_diamondvote_redpack',  'nickname')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_redpack')." ADD `nickname` varchar(50) NOT NULL COMMENT '昵称';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_redpack')) {
...
if(pdo_tableexists('tyzm_diamondvote_reply')) {
...
if(pdo_tableexists('tyzm_diamondvote_reply')) {
	if(!pdo_fieldexists('tyzm_diamondvote_reply',  'thumb')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_reply')." ADD `thumb` varchar(255) COMMENT '封面';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_reply')) {
...
if(pdo_tableexists('tyzm_diamondvote_reply')) {
	if(!pdo_fieldexists('tyzm_diamondvote_reply',  'topimg')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_reply')." ADD `topimg` varchar(255) COMMENT '背景图片';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_reply')) {
	if(!pdo_fieldexists('tyzm_diamondvote_reply',  'bgcolor')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_reply')." ADD `bgcolor` varchar(255) COMMENT '背景颜色';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_reply')) {
	if(!pdo_fieldexists('tyzm_diamondvote_reply',  'style')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_reply')." ADD `style` varchar(255) COMMENT '风格';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_reply')) {
...
if(pdo_tableexists('tyzm_diamondvote_reply')) {
	if(!pdo_fieldexists('tyzm_diamondvote_reply',  'shareimg')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_reply')." ADD `shareimg` varchar(255) COMMENT '分享图标';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_reply')) {
	if(!pdo_fieldexists('tyzm_diamondvote_reply',  'sharetitle')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_reply')." ADD `sharetitle` varchar(100) COMMENT '分享标题';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_reply')) {
	if(!pdo_fieldexists('tyzm_diamondvote_reply',  'sharedesc')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_reply')." ADD `sharedesc` varchar(300) COMMENT '分享简介';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_reply')) {
...
if(pdo_tableexists('tyzm_diamondvote_votedata')) {
...
if(pdo_tableexists('tyzm_diamondvote_votedata')) {
	if(!pdo_fieldexists('tyzm_diamondvote_votedata',  'avatar')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_votedata')." ADD `avatar` varchar(255) NOT NULL COMMENT '微信头像';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_votedata')) {
	if(!pdo_fieldexists('tyzm_diamondvote_votedata',  'nickname')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_votedata')." ADD `nickname` varchar(50) NOT NULL COMMENT '微信昵称';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_votedata')) {
...
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
...
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'avatar')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `avatar` varchar(255) NOT NULL COMMENT '微信头像';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'nickname')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `nickname` varchar(50) NOT NULL COMMENT '微信昵称';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
...
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'introduction')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `introduction` varchar(255) COMMENT '个人介绍';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'img1')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `img1` varchar(255) COMMENT '图1';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'img2')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `img2` varchar(255) COMMENT '图2';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'img3')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `img3` varchar(255) COMMENT '图3';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'img4')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `img4` varchar(255) COMMENT '图4';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'img5')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `img5` varchar(255) COMMENT '图5';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
...
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
	if(!pdo_fieldexists('tyzm_diamondvote_voteuser',  'atmsg')) {
		pdo_query("ALTER TABLE ".tablename('tyzm_diamondvote_voteuser')." ADD `atmsg` varchar(255) NOT NULL COMMENT '认证简介';");
	}	
}
if(pdo_tableexists('tyzm_diamondvote_voteuser')) {
