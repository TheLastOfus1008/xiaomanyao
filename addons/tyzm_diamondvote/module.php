	...
	public function fieldsFormDisplay($rid = 0)
	{
		...
		if (empty($rid)) {
			...
			if (empty($_GPC['copyid'])) {
				...
				$applydata = array('0' => array('infoname' => '手机', 'infotype' => 'mobile', 'notnull' => '1'));
				...
				$reply['title'] = $reply['title'] . '复制' . random(5, '1');
				...
				$bill_data = json_decode(str_replace('&quot;', '\'', $reply['bill_data']), '1');
				$tpl_setinput = $this->tpl_setinput($applydata);
