	...
	<form id="formID">
		<div>
			<ul class="fd_list2">
				...
				<div class="cont">
					<img src="<?php echo MODULE_URL;?>/template/static/images/jia.gif" class="bmimg" onclick="uploadbtn();">
...
<script type="text/javascript" src="<?php echo MODULE_URL;?>/template/static/js/dialog.js"></script>
<script>
	function test() {
		var fileInput = $("#file");
