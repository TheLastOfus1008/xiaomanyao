...
<html>
	...
	<body>
		...
		<div class="footerBtnGroup">
			...
			<a href="http://www.masxr.cn/app/index.php?i=2&c=entry&rid=<?php  echo $_GPC['rid'];?>&do=join&m=tyzm_diamondvote">我要参加</a>
		</div>
		...
		<script>
			...
			function getRmdList(callback) {
				var _url = "http://www.masxr.cn/app/index.php?i=2&c=entry&commend=1&do=data&rid=<?php  echo $_GPC['rid'];?>&m=tyzm_diamondvote&wxref=mp.weixin.qq.com"
			...
			function getListByPage(callback) {
				var ajaxUrl = 'http://www.masxr.cn/app/index.php?i=2&c=entry&do=data&m=tyzm_diamondvote&wxref=mp.weixin.qq.com&wxref=mp.weixin.qq.com&page=' + pageNum + '&limit=5&rid=<?php  echo $_GPC["rid"];?>'
...
//						layer.msg('已经到底了');
			...
			function toupiao(){
				...
				var _url='http://www.masxr.cn/app/index.php?i=2&c=entry&rid=<?php  echo $_GPC["rid"];?>&do=vote&id='+_num+'&m=tyzm_diamondvote'
				$.get(_url, function(ret) {
			...
			$(".actRuel").on("click",function(){
				location.href='http://www.masxr.cn/app/index.php?i=2&c=entry&rid=<?php  echo $_GPC["rid"];?>&do=introduction&m=tyzm_diamondvote'
			});
			...
			function getSearchList(_keyWords, callback) {
				var _url = "http://www.masxr.cn/app/index.php?i=2&c=entry&do=data&rid=<?php  echo $_GPC['rid'];?>&keywords=" + _keyWords + "&m=tyzm_diamondvote&wxref=mp.weixin.qq.com"
				$.get(_url, function(ret) {
