    ...
    <div class="we7-padding-bottom clearfix">
        <form action="./index.php" method="get" role="form" >
            ...
            <input type="hidden" name="do" value="manage" />
                <input type="text" name="keyword" value="<?php  echo $keyword;?>" class="form-control" placeholder="请输入活动名称"/>
        ...
        <tr>
            <td class="text-left vertical-middle">
                <div class="site-item-img">
                    <img src="<?php  echo tomedia($row['thumb']);?>" width="100px" />
                </div>
            </td>
            <td class="text-left"> 
                <div class="we7-margin-bottom">
                    <p class="color-gray">名称</p> 
                    <span class="color-dark"><?php  echo $row['title'];?></span>
                </div>
                <div class="">
            ...
            <td class="text-left">
                <div class="we7-margin-bottom" style="position: relative;">
                    ...
                    <a href="javascript:;" class="js-clip color-default cplink" data-url="<?php  echo $_W['siteroot'].'app/' ?><?php  echo $this->createMobileUrl('index',array('rid'=>$row['rid']))?>"  >复制活动链接  <img src="<?php  echo $row['qrcode'];?>"  width="120" /></a>
...
<p class="color-gray">参与人数：<span class="label label-primary"><?php  echo $row['jointotal'];?></span></p>
<p class="color-gray">视频个数：<span class="label label-success"><?php  echo $row['videocount'];?></span></p> 
<p class="color-gray">投票数量：<span class="label label-info"><?php  echo $row['votetotal'];?></span></p> 
<p class="color-gray">浏  览  量：<span class="label label-danger"><?php  echo $row['pvtotal'];?></span></p>
<p class="color-gray">分  享  量：<span class="label label-warning"><?php  echo $row['sharetotal'];?></span></p>
...
<!--                     <?php  if($row['config']['isredpack']==1) { ?>
                    ...
                    <?php  } ?> -->
<!--                     <?php  if($_W['account']['level']==4 || $_W['account']['level']==3) { ?> -->
