...
<div class="main1">
	...
	<li<?php  if($_GPC['ty'] == '3') { ?> class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('votelist',array('rid'=>$_GPC['rid'],'ty'=>3));?>">审核未通过</a></li>
    ...
    <div class="we7-padding-bottom clearfix">
        <form action="./index.php" method="get" role="form" >
            ...
            <input type="text" name="keyword" value="<?php  echo $keyword;?>" class="form-control" placeholder="输入视频编号、标题或手机号"/>
...
<!--         <div class="pull-right">
        ...
        <table class="table we7-table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    <td  class="text-left vertical-middle"><input type="checkbox" name="uid[]" value="<?php  echo $row['tid'];?>" class=""></td>
					<td  class="text-left vertical-middle"><img src="<?php  echo tomedia($row['voteuser']['avatar']);?>" width="48"><br />
						<?php  echo $row['tid'];?><?php  echo $row['voteuser']['nickname'];?>
					</td>
					<td class="text-left vertical-middle" style="max-width:180px;display: inline-block; overflow-x: auto;">
					<p>视频编号：<span class="label label-success"><?php  echo $row['num'];?></span></p>
					<p>视频标题：<span class="label label-success"><?php  echo $row['title'];?></span></p>
					<p>视频介绍：<span class="label label-success"><?php  echo $row['introduction'];?></span></p>
					<p>手机：<span class="label label-success" ><?php  echo $row['phone'];?></span><br/>
					</td>
	                <td class="text-left vertical-middle">
<p>
	                票数：<span class="label label-primary"><?php  echo $row['vote_num'];?></span>
</p><p>
                    ...
                    <td class="text-left vertical-middle">
                    <p>
                    <?php  if($row['status']==0) { ?><span class="label label-info audit" data-id="<?php  echo $row['id'];?>" data-s="1">待审核</span> <?php  } else if($row['status']==1) { ?><span class="label label-success audit" data-id="<?php  echo $row['id'];?>" data-s="0">审核通过</span><?php  } else { ?><span class="label label-danger audit" data-id="<?php  echo $row['id'];?>" data-s="0">审核不通过</span><?php  } ?>
					</p>
					<p>
                    <?php  if($row['commend']==1) { ?><span class="label label-success audit" data-id="<?php  echo $row['id'];?>" data-s="0">推荐视频</span><?php  } ?>
					</p>
					<p>
					</td>
                    <td  class="text-left vertical-middle">
					...
					<a class="color-default we7-margin-right" title="编辑" href="http://video-voting.test.upcdn.net<?php  echo $row['video_url'];?>" target="_blank"><i class="fa fa-edit"></i> 查看视频</a>
					</p><p>
